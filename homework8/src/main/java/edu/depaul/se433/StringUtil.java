...
public class StringUtil {
    ...
    static final String[][] plural = { { "axis", "axes" }, { "octopus", "octopi" }, { "virus", "viri" },
            { "sis", "ses" }, { "s", "ses" }, { "o", "oes" }, { "ium", "ia" }, { "f", "ves" }, { "ox", "oxen" },
            { "x", "xes" }, { "ch", "ches" }, { "sh", "shes" }, { "matrix", "matrices" }, { "vertex", "vertices" },
            { "index", "indices" }, { "mouse", "mice" }, { "louse", "lice" }, { "man", "men" },
            { "quiz", "quizzes" }, };

    static final String[][] irregular = { { "person", "people" }, { "child", "children" }, };

    static final String[] uncountable = { "equipment", "information", "rice", "money", "species", "series", "fish",
            "sheep", };
